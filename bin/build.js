...
function prepareJs() {
  ...
  execute(`concat -o ${dir}/js/concat.js ${dir}/js/constants.js ${dir}/js/Board.js ${dir}/js/BoardValidator.js ${dir}/js/LineCounter.js ${dir}/js/ComputerPlayer.js ${dir}/js/Connect4.js ${dir}/js/Connect4View.js`);
